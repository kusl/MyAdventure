...
/// onto <see cref="AvaloniaMainActivity{TApp}"/>'s <c>CustomizeAppBuilder</c>,
/// but in v12 those virtual methods are no longer called by the framework.
/// All AppBuilder configuration now lives here, on a class deriving from
